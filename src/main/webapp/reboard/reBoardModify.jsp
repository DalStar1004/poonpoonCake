...
String sql = " SELECT title,id,content FROM reboard";
	   sql+= " WHERE unq='"+unq+"' ";
...
<html>
    ...
    <body onload="fn_onload()">
                ...
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-md-10 col-lg-8 col-xl-7">
                        <div class="page-heading">
                            <h1>Revise Board</h1>
                            <span class="subheading">Please revise your inquiry</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <main class="mb-4">
			...
			<section>
				<article>
					<form name ="frm" method="post" action="reBoardModifySave.jsp" accept-charset="UTF-8">
					...
					<tbody>
						...
						<tr>
							<th>아이디</th>
							<td><input type="text" name="id" class="box_name" value="<%=session_id %>" ></td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
							<textarea name="content" rows="7" cols="58"><%=content %></textarea>
							</td>
						</tr>
					</tbody>
					</table>
					...
					<div style="width:100%; text-align:center; margin-top:10px;">
						<button type="button" onclick="history_back();return false;" class="buttonStyle">이전</button>
